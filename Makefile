...
#  📦  COMPOSER
#===================================================================================================
composer-require: docker-up ## Add composer dependencies, Usage: make composer-require p="package-name"
	docker exec -it $(DOCKER_CONTAINER_NAME) composer require $(p)
